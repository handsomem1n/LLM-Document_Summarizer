...
def setup_model():
    ...
    tokenizer = AutoTokenizer.from_pretrained(BASE_MODEL, device_map="cuda", token=os.environ['HUGGINGFACE_TOKEN'])
...
def train_model():
    # 데이터 로드
    prompts_dataset = load_data("extracted_data.json")
    ...
    training_args = TrainingArguments(
        ...
        remove_unused_columns=False  # 이 줄을 추가하여 모든 열을 모델에 전달
    )
